...
def dangky(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('taikhoan:xacthuc')
...
def thongtintaikhoan(request):
    ...
    return render(request, 'simso/page-taikhoan/thongtintaikhoan.html', Data)
...
def doimatkhau(request):
    ...
    return render(request, 'simso/page-taikhoan/doimatkhau.html', Data)
